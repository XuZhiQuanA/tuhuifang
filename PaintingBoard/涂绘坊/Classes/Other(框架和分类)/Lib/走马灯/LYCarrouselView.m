...
//    CGRect frame = self.bounds;
    CGRect frame = CGRectMake(0, 0, self.bounds.size.width*0.8, self.bounds.size.height*0.8);
...
//    CarrouselImageView *imv = [[CarrouselImageView alloc] initWithFrame:CGRectMake(x+ 50, y+ 50, w*0.8, h*0.8)];
    CarrouselImageView *imv = [[CarrouselImageView alloc] initWithFrame:CGRectMake(x+20, y+30, w, h)];
